...
export const addCashierValidationSchema = Yup.object({
  username: Yup.string()
    .required("Cashier's username is required.")
    .min(5, "Username length should be between 5 to 45 characters.")
    .max(45, "Username length should be between 5 to 45 characters."),

  email: Yup.string()
    .required("Cashier's email is required.")
